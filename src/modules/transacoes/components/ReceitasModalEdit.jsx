// src/modules/transacoes/components/ReceitasModalEdit.jsx
...
const ReceitasModalEdit = ({ isOpen, onClose, onSave, transacaoEditando }) => {
  ...
  if (!transacaoEditando && isOpen) {
    console.error('ReceitasModalEdit: transacaoEditando é obrigatória');
    return null;
  }
  ...
  // Estado do formulário (ATUALIZADO - sem observacoes)
  ...
  const previewInfo = useMemo(() => {
    ...
    return {
      ...
      mensagemSecundaria: 'Receita única',
      cor: '#F59E0B'
    };
  ...
  const preencherFormularioEdicao = useCallback(async () => {
    ...
    // ATUALIZADO - sem observacoes
    setFormData({
      valor: valorFormatado,
      data: transacaoEditando.data || new Date().toISOString().split('T')[0],
      descricao: transacaoEditando.descricao || '', // ATUALIZADO - sem replace, permite vazio
  ...
  const atualizarTransacao = useCallback(async () => {
    try {
      ...
      const dadosAtualizacao = {
        data: formData.data,
        descricao: formData.descricao.trim() || 'Receita', // Valor padrão se vazio
      ...
      <div className="forms-modal-container">
        ...
        <div className="modal-header">
          <div className="modal-header-content">
            ...
            <div>
              <h2 className="modal-title">Editar Receita</h2>
              <p className="modal-subtitle">
        ...
        <div className="modal-body">
          {loading ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* TIPO DE RECEITA - APENAS DISPLAY */}
              ...
              {/* PREVIEW */}
              {valorNumerico > 0 && (
                <div className="summary-panel success mb-3" style={{ borderColor: previewInfo.cor }}>
                  <div className="summary-header">
                    {previewInfo.icone}
                    <strong>Editando {tiposReceita.find(t => t.id === tipoTransacao)?.nome}</strong>
                  </div>
              ...
              <div className="flex flex-col mb-3">
                ...
                <small className="form-help-text">
                  Se deixar vazio, será preenchido automaticamente como "Receita"
                </small>
...
export default React.memo(ReceitasModalEdit);